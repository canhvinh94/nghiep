<footer id="footer">
    <div class="top-footer clearfix">
        <div class="container clearfix">
            <h3 class="tfooter-title">ĐĂNG KÝ NHẬN THÔNG TIN DỰ ÁN</h3>
            <div class="tfooter-details">
                <div class="row">
                    <div class="col-md-6">
                        <p><span style="font-size: 14pt;"><strong>LIÊN HỆ PHÒNG KINH DOANH</strong></span></p>
    ...
    <div class="bottom-footer clearfix">
        <div class="container">
            ...
            <div class="right-bfooter">
                <ul class="coinfo">
                    <li class="email-icon"><a href="mailto:<?php the_field('email','option')?>"><i class="fa fa-envelope"></i></a></li>
                    <li class="email-txt"><a href="mailto:<?php the_field('email','option')?>"><?php the_field('email','option')?></a></li>
                    <li class="hotline-icon"><a href="tel:<?php the_field('hotline','option')?>"><i class="fa fa-mobile"></i></a></li>
